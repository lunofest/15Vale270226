const CACHE_NAME = 'cache-v59'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v59',
    'estilos/styles.css?v59',
    'estilos/mediaQueries.css?v59',
    'javascript/script.js?v59',
